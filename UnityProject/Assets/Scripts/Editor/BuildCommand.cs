...
//         {
//             Console.WriteLine("=== CI Build Start ===");
//
//             // 强制刷新
...
//             WaitForCompile();
//
//             Console.WriteLine("=== Compilation Ready ===");
//
...
//             string buildPath = GetArg("-customBuildPath", args);
//             
//             
//             // 4. 配置构建选项
...
//                 throw new Exception( "[CUFramework] Build Failed!");
//             }
//
